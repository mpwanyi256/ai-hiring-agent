...
class QuestionService {
  ...
  async generateQuestionsForJob(
    params: QuestionGenerationRequest,
  ...
  private async generateTemplateQuestions(
    params: QuestionGenerationRequest,
  ...
  private getExperienceBasedQuestions(
    experienceLevel: string,
    jobTitle: string,
  ): Array<
    Omit<JobQuestion, 'id' | 'jobId' | 'createdAt' | 'updatedAt' | 'orderIndex' | 'isAiGenerated'>
  > {
    const questionMap: Record<
      ...
      Array<
        Omit<
          JobQuestion,
          'id' | 'jobId' | 'createdAt' | 'updatedAt' | 'orderIndex' | 'isAiGenerated'
        >
      >
    > = {
      entry: [
        ...
        {
          questionText:
            'How do you approach learning new technologies or skills when you encounter them in your work?',
          questionType: 'behavioral',
      ...
      mid: [
        {
          questionText:
            "Describe a challenging project you've worked on recently and how you overcame the obstacles you encountered.",
          questionType: 'experience',
        ...
        {
          questionText:
            'How do you handle competing priorities and tight deadlines in your current role?',
          questionType: 'behavioral',
      ...
      senior: [
        {
          questionText:
            'Tell me about a time when you led a team or mentored junior colleagues. What was your approach?',
          questionType: 'behavioral',
          category: 'Leadership',
          expectedDuration: 180,
          isRequired: true,
        ...
        {
          questionText:
            'How do you approach system design and architecture decisions? Walk me through your thought process.',
          questionType: 'technical',
  ...
  private getTraitQuestion(trait: string): string {
    const traitQuestionMap: Record<string, string> = {
      communication:
        "Describe a situation where you had to explain a complex concept to someone who wasn't familiar with the topic. How did you ensure they understood?",
      teamwork:
        'Tell me about a time when you had to work with a difficult team member or in a challenging team dynamic. How did you handle it?',
      leadership:
        'Give me an example of when you took initiative to solve a problem or improve a process without being asked.',
      'problem-solving':
        'Walk me through your approach to solving a complex problem you encountered recently. What was your methodology?',
      creativity:
        'Tell me about a time when you came up with an innovative solution to a challenge. What inspired your approach?',
      adaptability:
        'Describe a situation where you had to quickly adapt to significant changes in your work environment or project requirements.',
      'attention-to-detail':
        'Give me an example of when your attention to detail prevented a potential issue or improved an outcome.',
      'time-management':
  ...
  private getJobSpecificQuestions(
