...
export const selectJobQuestionsCount = (state: RootState) => state.jobs.currentJob?.questions?.length || 0;
export const selectJobQuestionStats = (state: RootState) => state.jobs.currentJob?.questionStats || null;
