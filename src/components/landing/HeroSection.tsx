            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 relative z-10 hover:shadow-2xl transition-all duration-300 hover-lift">
              ...
              <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-100">
                {[
                  ...
                  <div
                    key={index}
                    className="text-center hover:transform hover:scale-105 transition-all duration-300 cursor-pointer"
                  >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center mt-1">
                      {[...Array(4)].map((_, i) => (
                        <StarIcon
                          key={i}
                          className="w-2 h-2 text-yellow-400 fill-current hover:transform hover:scale-125 transition-transform duration-200"
                        />
                      ))}
