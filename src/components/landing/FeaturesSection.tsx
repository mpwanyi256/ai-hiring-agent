  ...
  const features = [
    {
      ...
      description: "Automated algorithmic phone calls recording that grant interviews platform and most relevant keyword and engagement analytics."
    },
    {
      icon: ChartBarIcon,
      title: "Efficient Evaluation", 
      description: "Real-time AI-powered data collection and analysis from phone interviews to help recruiters make more informed decisions."
    },
    {
      icon: UsersIcon,
      title: "Data-Driven Decisions",
      description: "Comprehensive AI-built candidate assessment from a talent conversation with more hiring intelligence and faster screening."
    }
  ];
      ...
      <Container>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="text-center group hover-lift fade-in" style={{animationDelay: `${index * 200}ms`}}>
