      ...
      <Container>
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-text max-w-3xl mx-auto">
            Let our team tell you how they admire about their experience in using Intervio as their
            human consultation platform.
          </p>
        </div>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div
                    className={`font-semibold ${testimonial.featured ? 'text-white' : 'text-text'}`}
                  >
                    {testimonial.name}
                  </div>
                  <div
