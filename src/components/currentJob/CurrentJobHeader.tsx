...
import { selectCurrentJob, selectJobQuestionsCount, selectJobsLoading } from "@/store/jobs/jobsSelectors";
    ...
    <div className="p-6 border-b border-gray-light">
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex flex-col items-end space-y-2">
                <span className={`px-3 py-1 text-sm font-medium rounded-full border ${getJobStatusColor(job.status)}`}>
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                variant="outline"
                size="sm"
                onClick={() => copyInterviewLink(job.interviewLink || `${window.location.origin}/interview/${job.interviewToken}`)}
