              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-900 mt-1">{getStatusLabel(job.status)}</p>
                  </div>
                  
                  <div>
                    <span className="text-sm font-medium text-gray-500">Interview Format</span>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900 mt-1">{formatDate(job.createdAt)}</p>
                  </div>
                </div>
              </div>
