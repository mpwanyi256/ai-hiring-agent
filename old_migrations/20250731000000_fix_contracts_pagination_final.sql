-- Final comprehensive fix for contracts pagination and API errors
-- This migration ensures the contracts API works properly by fixing function signatures and types

-- Drop all existing versions of get_contracts_paginated to avoid conflicts
...
-- Create the definitive get_contracts_paginated function that matches the API call
...
-- Ensure the analytics API functions use the correct return types
-- Update analytics API to use the corrected functions
