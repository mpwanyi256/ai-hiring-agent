-- Recreate notifications_details view
...
-- Synthetic notifications from contract offers for backward compatibility
SELECT 
...
-- Synthetic notifications from interviews for backward compatibility
SELECT 
