-- Migration: Fix grant_job_creator_permissions function to use correct notifications table structure
-- This fixes the column mismatch error in the notifications insertion
...
BEGIN
    ...
    -- Uses correct notifications table structure: company_id, category, related_entity_type, related_entity_id
...
COMMENT ON FUNCTION grant_job_creator_permissions() IS 'Grants admin permissions to job creator and creates notifications for all company users using correct notifications table structure'; 